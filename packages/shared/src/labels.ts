...
const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  holds_expired: "Hold kedaluwarsa (batch)",
  report_exported: "Laporan diekspor",
  media_uploaded: "Media diunggah",
  media_deleted: "Media dihapus",
  promo_created: "Promo dibuat",
  promo_updated: "Promo diubah",
  price_tier_deleted: "Tier harga dihapus",
  settings_changed: "Pengaturan diubah",
  content_draft_saved: "Draf konten disimpan",
  content_published: "Konten diterbitkan",
  content_reverted: "Konten dikembalikan",
  content_draft_reset: "Draf konten dibersihkan",
  ...
  schedule_status_changed: "Status jadwal diubah",
  schedule_bulk_status: "Status jadwal massal",
  schedule_generated: "Jadwal digenerate",
  schedule_duplicated: "Jadwal diduplikasi",
  package_created: "Paket dibuat",
  package_updated: "Paket diubah",
